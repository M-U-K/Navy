...
If rewrite is false, the given size is added to the lenght of the given string

my_realloc create a new string, so if you \
want free the given string set want_free to true */
...
str_clear create a new string, so if you want free the given \
string str set want_free to true */
...
/* Return true if the given string contain a \
POSTIVE number, else false is return */
...
Return an int who indicate the begining of to_find\
 in str or -1 if to_find is not find in str */
...
/* Make all the first letters of each words in the given string str in uppercase
